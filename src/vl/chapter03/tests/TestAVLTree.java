...
import vl.chapter03.utils.ACommonFormat;
import vl.chapter03.utils.INodeToData;
...
class CommonFormat extends ACommonFormat {
    ...
    public CommonFormat()
        ...
        Class<?> nodeClass = Class.forName("kapitel_3.vl.BTree$Node");
        Class<?> aVLLayerClass = Class.forName("kapitel_3.work.experiments.AVLTree$AVLLayer");
